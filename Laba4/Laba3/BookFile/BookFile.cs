...
namespace Laba2.BookFile
{
    public class BookFile
    {
        ...
        public BookFile(IBookFileFactory bookFileFactory)
        {
            var bookfileInfo = bookFileFactory.CreateBookInfo();

            Format = bookfileInfo.Format;
            Size = bookfileInfo.Size;
            Name = bookfileInfo.Name;
            Udc = bookfileInfo.Udc;
            NumberOfPages = bookfileInfo.NumberOfPages;
            Year = bookfileInfo.Year;

            PublishingHouse = bookFileFactory.CreatePublishingHouse();
            Authors = bookFileFactory.CreateAutorsList();
        }
        ...
        [Required] [UDC] public string Udc { get; set; }

        [Required]
        [Range(1, 1000, ErrorMessage = "Значение числа страниц от 1 до 1000 ")]
        public int NumberOfPages { get; set; }

        [Required] public PublishingHouse PublishingHouse { get; set; }
